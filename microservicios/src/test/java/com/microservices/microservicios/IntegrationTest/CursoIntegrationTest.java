...
import com.microservices.microservicios.repository.CursoRepository; // Ruta corregida si es 'repository' en lugar de 'repositories'
...
public class CursoIntegrationTest {
    ...
    void testService_VerTodosLosCursos() {
        ...
        // Act
        List<Curso> cursos = cursoService.verCursos(); // Tu método verCursos devuelve ArrayList, pero List es más general.
    ...
    void testService_BuscarCursoPorIdExistente() {
        ...
        // Act
        Optional<Curso> encontrado = cursoService.buscarCurso(cursoExistente.getId()); // Tu servicio tiene 'buscarCurso'
    ...
    void testService_ActualizarCursoNoExistenteDebeLanzarNoSuchElementException() {
        ...
        // Act & Assert
        // Basado en tu CursoService original: findById(id).get() lanza NoSuchElementException si no encuentra
    ...
    void testService_EliminarCursoExistente() {
        ...
        // Act
        Boolean resultado = cursoService.eliminarPorId(cursoAEliminar.getId()); // Tu servicio usa 'eliminarPorId'
